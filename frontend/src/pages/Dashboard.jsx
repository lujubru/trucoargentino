...
const Dashboard = () => {
  ...
  const fetchData = async () => {
    try {
      const [tablesRes, depositsRes, historyRes] = await Promise.all([
        api.get('/tables'),
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              <Button
                ...
                className="btn-gold h-14 text-base"
              ...
              <Button
                ...
                className="bg-[#2ECC71] hover:bg-[#27AE60] h-14 text-base text-white"
              ...
              <Button
                ...
                variant="outline"
                className="border-white/20 text-white hover:bg-white/5 h-14 text-base"
            ...
            >
              <h2 className="font-display text-2xl text-white mb-4">MESAS PÚBLICAS</h2>
